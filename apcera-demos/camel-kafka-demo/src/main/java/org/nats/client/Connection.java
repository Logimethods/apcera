...
public class Connection {
	...
	public static final int DEFAULT_PORT = 55299;
	public static String DEFAULT_URI = "nats://192.168.0.135:" + Integer.toString(DEFAULT_PORT);
	...
	public Connection() throws IOException, InterruptedException{
		...
		System.out.println("Getting Env Var ...");
		String CONNECTION_URI = System.getenv("NATS_URI");
		System.out.println("Connection URL: " + CONNECTION_URI);

		DEFAULT_URI = CONNECTION_URI;
		init(popts);
